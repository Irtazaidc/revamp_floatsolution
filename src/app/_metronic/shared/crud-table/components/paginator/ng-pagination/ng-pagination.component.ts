 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationEllipsis]', standalone: false })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationFirst]', standalone: false })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationLast]', standalone: false })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationNext]', standalone: false })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationNumber]', standalone: false })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'ng-template[ngPaginationPrevious]', standalone: false })
