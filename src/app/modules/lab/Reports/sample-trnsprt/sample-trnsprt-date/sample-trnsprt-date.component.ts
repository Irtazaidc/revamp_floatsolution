...
@Component({
  ...
  selector: 'app-sample-trnsprt-date',
  templateUrl: './sample-trnsprt-date.component.html',
  styleUrls: ['./sample-trnsprt-date.component.scss']
})
export class SampleTrnsprtDateComponent implements OnInit {
 ...
 exportAsExcel() {  
  ...
  if(this.TestProfileDataList.length){
   ...
   this.excelService.exportAsExcelFile(excelData, 'Sample Transport Date Wise','SampleTransportDateWise'); 
  }
  else{
