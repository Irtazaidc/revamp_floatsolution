...
@Component({
  ...
  selector: 'app-lab-testing-date',
  templateUrl: './lab-testing-date.component.html',
  styleUrls: ['./lab-testing-date.component.scss']
})
export class LabTestingDateComponent implements OnInit {
 ...
 getlabtestformDataList(){
   ...
   this.labTats.getLabTestingTATDateWise(objParams).subscribe((res: any) => {
     console.log("res:", res)
 ...
 subSectionList = []
  ...
  exportAsExcel() {  
    ...
    if (this.TestProfileDataList.length){
     ...
     this.excelService.exportAsExcelFile(excelData, 'Lab Testing Date Wise','LabTestingDateWise');
    }
    else{
