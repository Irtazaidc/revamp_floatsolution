...
@Component({
  ...
  selector: 'app-delayed-approvals',
  templateUrl: './delayed-approvals.component.html',
  styleUrls: ['./delayed-approvals.component.scss']
})
export class DelayedApprovalsComponent implements OnInit {
  ...
  getCancellationRequests() {
    ...
    this.spinner.show();
    this.visitService.GetVisitsForAdvCancellationApprove(params).subscribe( (res: any) => {
      this.spinner.hide();
