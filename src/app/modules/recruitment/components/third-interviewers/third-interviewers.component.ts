...
@Component({
  ...
  selector: 'app-third-interviewers',
  templateUrl: './third-interviewers.component.html',
  styleUrls: ['./third-interviewers.component.scss']
})
export class ThirdInterviewersComponent implements OnInit {
