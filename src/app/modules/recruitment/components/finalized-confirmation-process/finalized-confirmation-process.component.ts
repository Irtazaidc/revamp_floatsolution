...
@Component({
  ...
  selector: 'app-finalized-confirmation-process',
  templateUrl: './finalized-confirmation-process.component.html',
  styleUrls: ['./finalized-confirmation-process.component.scss']
})
export class FinalizedConfirmationProcessComponent implements OnInit {
  ...
  changeJobApplicantRequestStatus(statusID){
    ...
    if(statusID==10){
      alertMessage = 'Applicant has been Confirmed successfully';
    }else if(statusID==3){
    ...
    if(this.formUpdateStatus.valid) {
      const objParam = {
        ...
        tblJobApplicantStatus: [{
          ...
          "InterviewDate":null, 
          "JoiningDate":   (formValues.JoiningDate)?Conversions.formatDateObject(formValues.JoiningDate):null
  ...
  getApplicantStatus(){
    ...
    this.recruitment.getApplicantStatus().subscribe((res: any) => {
      ...
      resApplicanttStatus = resApplicanttStatus.filter( a=> (a.ApplicantStatusID == 3 || a.ApplicantStatusID == 13));
        ...
        const objParam = {
          ...
          tblJobApplicantStatus: jobListChecked.map( a => {
            return {
              ...
              InterviewDate: null,
              JoiningDate:  (a.ApplicantStatusID==13 && JoiningDate!=null)?JoiningDate:null
