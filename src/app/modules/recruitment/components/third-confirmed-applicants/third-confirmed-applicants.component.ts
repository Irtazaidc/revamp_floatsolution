...
@Component({
  ...
  selector: 'app-third-confirmed-applicants',
  templateUrl: './third-confirmed-applicants.component.html',
  styleUrls: ['./third-confirmed-applicants.component.scss']
})
export class ThirdConfirmedApplicantsComponent implements OnInit {
  ...
  getApplicantList(){
    ...
    this.recruitment.getApplicantList(objParm).subscribe((res:any)=>{
      ...
      if(res.StatusCode==200){
        ...
        // this.ApplicantList = this.ApplicantList.filter( a=> (a.ApplicantStatusID == 5));
      }
    }, (err) => {
      console.log(err);
  ...
  getApplicantStatus(){
    ...
    this.recruitment.getApplicantStatus().subscribe((res: any) => {
      ...
      resApplicanttStatus = resApplicanttStatus.filter( a=> (a.ApplicantStatusID == 3 || a.ApplicantStatusID == 2));
