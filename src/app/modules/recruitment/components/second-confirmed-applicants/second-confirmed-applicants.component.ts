...
@Component({
  ...
  selector: 'app-second-confirmed-applicants',
  templateUrl: './second-confirmed-applicants.component.html',
  styleUrls: ['./second-confirmed-applicants.component.scss']
})
export class SecondConfirmedApplicantsComponent implements OnInit {
