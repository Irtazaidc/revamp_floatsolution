...
@Component({
  ...
  selector: 'app-third-interview-process',
  templateUrl: './third-interview-process.component.html',
  styleUrls: ['./third-interview-process.component.scss']
})
export class ThirdInterviewProcessComponent implements OnInit {
