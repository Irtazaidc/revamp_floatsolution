...
@Component({
  ...
  selector: 'app-second-shortlisted-applicants',
  templateUrl: './second-shortlisted-applicants.component.html',
  styleUrls: ['./second-shortlisted-applicants.component.scss']
})
export class SecondShortlistedApplicantsComponent implements OnInit {
  ...
  getApplicantStatus(){
    ...
    this.recruitment.getApplicantStatus().subscribe((res: any) => {
      ...
      resApplicanttStatus = resApplicanttStatus.filter( a=> (a.ApplicantStatusID == 3 || a.ApplicantStatusID == 7));
        ...
        const objParam = {
          ...
          tblJobApplicantStatus: jobListChecked.map( a => {
            return {
              ...
              InterviewDate:  (a.ApplicantStatusID==5 && interviewDate!=null)?interviewDate:null,
              JoiningDate:null
