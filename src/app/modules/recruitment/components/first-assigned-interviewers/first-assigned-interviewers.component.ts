...
@Component({
  ...
  selector: 'app-first-assigned-interviewers',
  templateUrl: './first-assigned-interviewers.component.html',
  styleUrls: ['./first-assigned-interviewers.component.scss']
})
export class FirstAssignedInterviewersComponent implements OnInit {
