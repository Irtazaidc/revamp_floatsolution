...
@Component({
  ...
  selector: 'app-second-confirmation-process',
  templateUrl: './second-confirmation-process.component.html',
  styleUrls: ['./second-confirmation-process.component.scss']
})
export class SecondConfirmationProcessComponent implements OnInit {
