...
export class InterviewResultComponent implements OnInit {
  ...
  ApplicantAddress = "";
  CVFile = "";
  isInterviewDateRequired:boolean=true;
  ...
  getApplicantStatus() {
    ...
    this.recruitment.getApplicantStatus().subscribe((res: any) => {
      ...
      resApplicanttStatus = resApplicanttStatus.filter(a => (a.ApplicantStatusID == 3 || a.ApplicantStatusID == 6));
