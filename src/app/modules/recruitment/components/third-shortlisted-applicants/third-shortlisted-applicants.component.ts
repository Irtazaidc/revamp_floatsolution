...
@Component({
  ...
  selector: 'app-third-shortlisted-applicants',
  templateUrl: './third-shortlisted-applicants.component.html',
  styleUrls: ['./third-shortlisted-applicants.component.scss']
})
export class ThirdShortlistedApplicantsComponent implements OnInit {
  ...
  getApplicantStatus(){
    ...
    this.recruitment.getApplicantStatus().subscribe((res: any) => {
      ...
      resApplicanttStatus = resApplicanttStatus.filter( a=> (a.ApplicantStatusID == 3 || a.ApplicantStatusID == 10));
