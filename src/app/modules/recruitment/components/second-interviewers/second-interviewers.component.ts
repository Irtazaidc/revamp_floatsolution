...
@Component({
  ...
  selector: 'app-second-interviewers',
  templateUrl: './second-interviewers.component.html',
  styleUrls: ['./second-interviewers.component.scss']
})
export class SecondInterviewersComponent implements OnInit {
