...
@Component({
  ...
  selector: 'app-third-assigned-interviewers',
  templateUrl: './third-assigned-interviewers.component.html',
  styleUrls: ['./third-assigned-interviewers.component.scss']
})
export class ThirdAssignedInterviewersComponent implements OnInit {
