...
@Component({
  ...
  selector: 'app-tech-audit-summary-report-branch-mgr',
  templateUrl: './tech-audit-summary-report-branch-mgr.component.html',
  styleUrls: ['./tech-audit-summary-report-branch-mgr.component.scss']
})
export class TechAuditSummaryReportBranchMgrComponent implements OnInit {
  ...
  getRISTechnologistAuditSummary() {
    ...
    if (this._form.invalid) {
      ...
      const objParams = {
        ...
        LocID: this.loggedInUser.locationid || null,
  ...
  printToExcel() {
    ...
    this.risWorklistForExport.forEach((dataItem, index) => {
      const row = {
        ...
        'ManagerRemarks': dataItem.ManagerRemarks || 'NA',
        'ApprovedFine': dataItem.ApprovedFine || 'NA',
