...
@Component({
  ...
  selector: 'app-initial-recommend-reject-request',
  templateUrl: './initial-recommend-reject-request.component.html',
  styleUrls: ['./initial-recommend-reject-request.component.scss']
})
export class InitialRecommendRejectRequestComponent implements OnInit {
