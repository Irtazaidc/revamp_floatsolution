...
@Component({
  ...
  selector: 'app-emp-dependent-info',
  templateUrl: './emp-dependent-info.component.html',
  styleUrls: ['./emp-dependent-info.component.scss']
})
export class EmpDependentInfoComponent implements OnInit, OnDestroy {
  formGroup: FormGroup;
  user: UserModel;
