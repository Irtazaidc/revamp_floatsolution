      ...
      (y = [
        {
          ...
          value: function (e) {
            u.style.setProperty("--offsetX", "".concat(e.endX, "px")),
              u.style.setProperty("--offsetY", "".concat(e.endY + 30, "px")),
              u.style.setProperty("--scale", "".concat(e.scale)),
              u.style.setProperty("--rotate", "".concat(e.rotate, "deg"));
          },
        },
      ]),
      (v = [
        ...
        },
        {
          ...
          value: function () {
            ...
            this.imageElements.forEach(function (t, n) {
              ...
              u.addEventListener(
                ...
                function (t) {
                  var n = e.config.zoom,
                    ...
                    o = n.max,
                    s = n.step;
                  t.wheelDelta > 0 && h < o ? (h += s) : h > i && (h -= s),
                    u.style.setProperty("--scale", "".concat(h.toFixed(2)));
                },
                !0
              ),
              document
              ...
              r.addEventListener("mousewheel", t),
              (document.ondragstart = t),
              (document.ondragend = t),
              (window.onresize = function (e, t) {
                var n = null;
                return function (i) {
                  clearTimeout(n),
        ...
        },
        {
          key: "handleReset",
          value: function () {
            (u.style.top = "".concat(m.startY, "px")),
              (u.style.left = "".concat(m.startX, "px")),
              u.style.setProperty("--rotate", "".concat(0, "deg")),
              u.style.setProperty("--scale", "".concat(m.scale));
          },
        },
        {
          key: "handleOpen",
          ...
          value: function () {
            ...
            if (
              ...
              var m = (function (e) {
                ...
                g = m.width,
                p = m.height;
              u.style.cssText = "width:"
                .concat(g, "px;height:")
                .concat(p, "px;position: fixed; top: ")
                .concat(h, "px; left: ")
                .concat(f, "px;");
            } else
        ...
        },
        {
          ...
          value: function () {
            (m.rotate -= 90),
              u.style.setProperty("--rotate", "".concat(m.rotate, "deg"));
          },
        },
        {
        ...
        },
        {
          ...
          value: function (e) {
            var t = this.config.ratio,
              ...
              a = n.width,
              c = n.src;
            u.classList.add("moving"),
              o(u, a, s, d / 2 - a / 2, l / 2 - s / 2),
              (m = { endX: 0, endY: 0, scale: i(a, s, t), rotate: 0 }),
              (u.src = c),
              g.setImageAnimationParams(m),
              setTimeout(function () {
          ...
          value: function () {
            ...
            e
              ...
              : ((r = document.createElement("div")).classList.add(
                ...
                c.appendChild(r)),
              (u = document.getElementById("preview-image"));
          },
        },
        {
          key: "init",
